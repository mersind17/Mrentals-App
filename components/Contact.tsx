        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          ...
          >
            ...
            <div className="space-y-8">
              {/* Location */}
              <div className="group flex items-start space-x-6 p-6 rounded-[32px] hover:bg-white/5 transition-all border border-transparent hover:border-white/5">
                <div className="bg-[#acc8a2] p-4 rounded-2xl text-[#182521] shadow-lg shadow-[#acc8a2]/20 group-hover:scale-110 transition-transform">
              ...
              <div className="group flex items-start space-x-6 p-6 rounded-[32px] hover:bg-white/5 transition-all border border-transparent hover:border-white/5">
                ...
                <div>
                  ...
                  <a href={`https://wa.me/${WHATSAPP_NUMBER}`} className="text-xl font-bold text-white hover:text-[#acc8a2] transition-colors block">
                    +{WHATSAPP_NUMBER}
                  </a>
              ...
              <div className="group flex items-start space-x-6 p-6 rounded-[32px] hover:bg-white/5 transition-all border border-transparent hover:border-white/5">
                ...
                <div>
                  ...
                  <a href="https://instagram.com/mrentals_al" target="_blank" className="text-xl font-bold text-white hover:text-[#acc8a2] transition-colors block">
                    @mrentals_al
                  </a>
                </div>
              </div>
          ...
          >
            <div className="absolute -inset-2 bg-[#acc8a2]/10 rounded-[60px] blur-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-700"></div>
            ...
            <div className="relative h-full w-full rounded-[60px] overflow-hidden border-[12px] border-white/5 bg-[#141f1b] shadow-2xl">
              ...
              <div className="absolute bottom-8 left-1/2 -translate-x-1/2 w-auto min-w-[240px] bg-[#141f1b]/90 backdrop-blur-lg border border-white/10 p-4 rounded-[32px] flex items-center justify-center shadow-2xl group-hover:translate-y-[-5px] transition-transform duration-500">
                <a
                  href={GOOGLE_MAPS_URL}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="bg-[#acc8a2] hover:bg-[#9db893] text-[#182521] px-10 py-4 rounded-2xl font-black text-[10px] uppercase tracking-widest transition-all shadow-xl shadow-[#acc8a2]/10 flex items-center group/btn"
                >
