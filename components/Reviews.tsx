      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          {reviews.map((review, idx) => (
            <div
              key={review.id}
              className={`bg-white p-10 rounded-[40px] shadow-2xl flex flex-col hover:scale-[1.02] active:scale-[1.02] transition-all duration-500 group ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-16'}`}
              style={{ transitionDelay: `${400 + idx * 150}ms` }}
            >
              <div className="flex items-center justify-between mb-8">
                <div className="flex items-center space-x-4">
                  <div className="w-14 h-14 bg-[#182521] text-[#acc8a2] rounded-2xl flex items-center justify-center font-black text-2xl group-hover:rotate-6 group-active:rotate-6 transition-transform">
                    {review.name[0]}
                  </div>
                  <div>
              ...
              <p className="text-gray-600 font-medium mb-10 leading-relaxed line-clamp-4 group-hover:line-clamp-none group-active:line-clamp-none transition-all">
                "{review.comment}"
              </p>
            </div>
          ))}
        ...
        >
          <a
            ...
            className="bg-white text-[#182521] px-10 py-5 rounded-[24px] font-black text-xs uppercase tracking-[0.2em] shadow-xl hover:bg-[#acc8a2] active:bg-[#acc8a2] transition-all flex items-center group"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="text-white border border-white/20 hover:border-[#acc8a2] active:border-[#acc8a2] px-10 py-5 rounded-[24px] font-black text-xs uppercase tracking-[0.2em] transition-all hover:bg-white/5 active:bg-white/5"
          >
