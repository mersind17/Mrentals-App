        ...
        <div className="max-w-4xl mx-auto flex flex-col items-center">
          ...
          >
            <button
              ...
              className="w-full sm:w-auto bg-[#acc8a2] hover:bg-[#9db893] text-[#182521] px-16 py-7 rounded-[28px] font-black text-xl shadow-[0_20px_60px_rgba(172,200,162,0.3)] hover:scale-105 transition-all flex items-center justify-center group"
            >
              {t('btn_view_cars')}
