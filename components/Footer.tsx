      ...
      <div className="container mx-auto px-6 flex flex-col items-center text-center relative z-10">
        ...
        >
          <button
            ...
            className="group flex items-center space-x-4 bg-[#acc8a2] hover:bg-[#9db893] active:bg-[#9db893] text-[#182521] px-12 py-6 rounded-[24px] font-black text-sm uppercase tracking-[0.25em] transition-all duration-500 transform hover:scale-105 active:scale-105 shadow-[0_20px_50px_rgba(172,200,162,0.2)]"
          >
            ...
            <svg className="w-5 h-5 group-hover:translate-x-1.5 group-active:translate-x-1.5 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {/* Logo */}
        <div
          className={`mb-12 transform hover:scale-105 active:scale-105 transition-all duration-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}
