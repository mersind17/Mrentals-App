  ...
  return (
    <section ref={sectionRef} className="bg-[#182521] py-32 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          <div className="bg-[#acc8a2]/10 border border-[#acc8a2]/20 rounded-[32px] p-6 md:p-10 flex flex-col md:flex-row items-center justify-between group hover:bg-[#acc8a2]/15 active:bg-[#acc8a2]/15 transition-all duration-500">
            <div className="flex items-center space-x-6 mb-6 md:mb-0">
              <div className="bg-[#acc8a2] text-[#182521] w-16 h-16 rounded-2xl flex items-center justify-center shadow-lg group-hover:scale-110 group-active:scale-110 transition-transform duration-500">
